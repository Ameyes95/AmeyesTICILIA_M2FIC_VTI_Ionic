...
export class FilterPage extends Stepper {
  ...
  filter = {
    ...
    endDate: '',
    category: '',
    month: new Date().toISOString() //Initialisé au mois en cours
  };
  ...
  //Upload de la liste des dépenses de façon simple (basic)
  public loadBasic() {
    ...
    //Recupération des données depuis firebase (afs)
  ...
  //Upload de la liste des dépenses de façon avancée (advanced)
  ...
  //Somme dse dépenses pour la période séléctionnée
  findTotal(){
